...
void initializeConsole() {
	...
	addConsoleAction("hello", sayHello);
	  ...
	  addConsoleAction("show_blt_version", [](){
	    #define BLT_BIN_VERSION_ADDR              ((uint32_t)0x08008024U)       /*! 3rd reserved DWORD in vector table search:openblt_version */
      	uint32_t *bltBinVersion = ((uint32_t *)BLT_BIN_VERSION_ADDR);
